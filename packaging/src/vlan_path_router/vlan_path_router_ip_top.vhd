...
--
--   committed_bus_t  ->  two AXI4-Stream interfaces, l1_i and l1_o
...
begin
  ...
  l1_in_s.req <= framed_flit(data  => std_ulogic_vector(l1_i_tdata),
                             last  => l1_i_tlast = '1',
                             valid => l1_i_tvalid = '1');
  l1_in_s.ack <= framed_accept(l1_o_tready = '1');

  l1_i_tready <= l1_out_s.ack.ready;
  l1_o_tdata  <= std_logic_vector(l1_out_s.req.data);
  l1_o_tvalid <= l1_out_s.req.valid;
  l1_o_tlast  <= l1_out_s.req.last;
