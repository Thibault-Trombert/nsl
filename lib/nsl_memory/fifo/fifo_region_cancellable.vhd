...
library nsl_logic, nsl_memory, nsl_math, nsl_simulation, nsl_data, nsl_amba;
use nsl_logic.bool.all;
use nsl_data.text.all;
use nsl_simulation.logging.all;
use nsl_amba.axi4_stream.all;

entity fifo_region_cancellable is
  generic(
...
architecture beh of fifo_region_cancellable is    
  ...
  signal s_wptr_end, s_next_wregion, s_next_rregion, s_next_wregion_sp, s_next_rregion_sp : ptr_t;
...
begin
  ...
  transition: process(r, out_ready_i,
                      ...
                      s_next_wregion_sp, s_next_rregion_sp) is
    variable axi_data_v : master_t;
  begin
    rin <= r;
    ...
    if out_commit_i = '1' then
      ...
      rin.rptr_sp  <= s_next_rregion;
      rin.rptr_mem <= s_next_rregion;
